...
public class Account {
	...
	int withdrwaw;
	int balance;
	Account(int deposite_balance){
		this.deposite_balance = deposite_balance;  //1000
		System.out.println("Initial Balance: "+deposite_balance); 
	}
	...
	public static void main(String[] args) {
		Account ac = new Account(1000); //1000 is AC balance, 500 is deposited balance , 200 is withdrawn balance
